    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center justify-center gap-1 px-9 py-3 max-sm:mt-4 max-sm:w-full bg-primary hover:bg-primary-dull text-white rounded-full cursor-pointer"
        >
          <img
